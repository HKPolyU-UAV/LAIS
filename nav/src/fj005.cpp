...
static string testconfig_path = "/home/panda/fyrws/src/nav/config/testconfig.yaml";
...
static nav::identify_command identify_flag;
...
void objects_cb(const nav::Objects::ConstPtr & Objects){
...
int main(int argc, char **argv)
{
    ...
    //    vector <double> a = cross_point(x1[0],x1[1], x0[0], x0[1], 2 , "x");
    ...
    ros::Publisher identify_pub = nh.advertise<nav::identify_command>("/identify", 1);
    ros::Publisher marker_pub = nh.advertise<visualization_msgs::Marker>("/visualization_marker", 10);
    ros::Publisher approach_pub = nh.advertise<visualization_msgs::Marker>("/approach_marker", 10);
    ros::Subscriber objects_sub = nh.subscribe <nav::Objects>("/Objects_array", 1, objects_cb);

    //    image_transport::ImageTransport it(nh);
    //    image_transport::Subscriber rgb_sub = it.subscribe("/camera/color/image_raw", 1, rgb_image_cb);
    ...
    while(ros::ok())
    {
        ...
        //        YAML::Node config = YAML::LoadFile(testconfig_path);
        //        cout << "265" << endl;
        //        traffic_x = getDoubleVariableFromYamlhierarchy(testconfig_path,"traffic light","X_w");
        //        cout << "266" << endl;
        //        traffic_y = getDoubleVariableFromYamlhierarchy(testconfig_path,"traffic light","Y_w");
        //        cout << "267" << endl;
        //        traffic_z = getDoubleVariableFromYamlhierarchy(testconfig_path,"traffic light","Z_w");
        //        cout << "268" << endl;
        //        traffic_obs = getBoolVariableFromYamlhierarchy(testconfig_path,"traffic light","obstacle");
        //        cout << "269" << endl;
        //        bulb_x = getDoubleVariableFromYamlhierarchy(testconfig_path,"bulb","X_w");
        //        cout << "270" << endl;
        //        bulb_y = getDoubleVariableFromYamlhierarchy(testconfig_path,"bulb","Y_w");
        //        cout << "271" << endl;
        //        bulb_z = getDoubleVariableFromYamlhierarchy(testconfig_path,"bulb","Z_w");
        //        cout << "272" << endl;
        //        bulb_obs = getBoolVariableFromYamlhierarchy(testconfig_path,"bulb","obstacle");
        //        cout << "273" << endl;
        //        cctv_x = getDoubleVariableFromYamlhierarchy(testconfig_path,"cctv","X_w");
        //        cout << "274" << endl;
        //        cctv_y = getDoubleVariableFromYamlhierarchy(testconfig_path,"cctv","Y_w");
        //        cout << "275" << endl;
        //        cctv_z = getDoubleVariableFromYamlhierarchy(testconfig_path,"cctv","Z_w");
        //        cout << "276" << endl;
        //        cctv_obs = getBoolVariableFromYamlhierarchy(testconfig_path,"cctv","obstacle");
        //        cout << "277" << endl;
        ...
        points.header.frame_id = line_strip.header.frame_id = line_list.header.frame_id = sphere.header.frame_id = "world";
        points.header.stamp = line_strip.header.stamp = line_list.header.stamp = sphere.header.stamp = ros::Time::now();
        points.ns = line_strip.ns = line_list.ns = sphere.ns = "points_and_lines";
        points.action = line_strip.action = line_list.action = sphere.action = visualization_msgs::Marker::ADD;
        points.pose.orientation.w = line_strip.pose.orientation.w = line_list.pose.orientation.w = sphere.pose.orientation.w = 1.0;
        ...
        obj3.y = o2_y;
        obj3.z = o2_z;
        sphere.points.push_back(obj1);
        sphere.colors.push_back(color);
        sphere.points.push_back(obj2);
        sphere.colors.push_back(color);
        sphere.points.push_back(obj3);
        sphere.colors.push_back(color);
